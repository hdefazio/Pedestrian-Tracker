...
//@brief message for detection threshold
//----------------------------------
static const char detector_thresh_message[] = "Optional. Value for the detector threshold. Default is 0.5.";

//@brief message for input_h
static const char input_h_message[] = "Optional. Value for image height. Default is 1920.";

//@brief message for input_w
static const char input_w_message[] = "Optional. Value for image width. Default is 1200.";
//----------------------------------
...
//@brief Define parameter for detection threshold value
//Optional
//---------------------------------
DEFINE_double(d_thr, 0.5, detector_thresh_message);


//@brief Define parameter for input_h value
//Optional
DEFINE_int32(in_h, 1920, input_h_message);

//@brief Define parameter for input_w value
//Optional
DEFINE_int32(in_w, 1200, input_w_message);
//---------------------------------
...
static void showUsage() {
    ...
    //-----------------------------------------------------
    std::cout << "    -d_thr                         " << detector_thresh_message << std::endl;
    std::cout << "    -in_h                          " << input_h_message << std::endl;
    std::cout << "    -in_w                          " << input_w_message << std::endl;
}
